 ...
 * - {@link hearingDialogOpen}, {@link announcementsOpen}, and {@link insideAnnouncements}
...
function handleFadeOnHoverInteractionChange() {
  ...
  if (hearingDialogOpen.value || announcementsOpen.value) {
...
watch(
  [isOutsideFor250Ms, insideAnnouncements, announcementsOpen, isAroundWindowBorderFor250Ms, isOutsideWindow, isTransparent, isTransparentForMouseEvents, hearingDialogOpen, fadeOnHoverEnabled, stagePaused],
